...
# page_icon fügt das Symbol im Browser-Tab hinzu
st.set_page_config(page_title="Makro Terminal", page_icon="📈", layout="wide")
...
st.markdown("""
    <div class='header-container'>
        ...
        <h1 class='main-title'>MAKRO TERMINAL</h1>
    </div>
...
if not n_raw.empty and not dis_raw.empty:
    try:
        ...
        st.error("Daten-Struktur Fehler.")
